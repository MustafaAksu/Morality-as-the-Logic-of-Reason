...
\subsection{Non-Abelian Parallel Transport}\label{subsec:su2-transport}
...
\mathcal{J}^2=-I \label{eq:Jdef}\\[6pt]
H(C)&=\exp\!\left(i\sum_{e\in C}\epsilon_e A_e\right) \label{eq:Hdef}\\[6pt]
\mathbf{F}_{ijk}&=\log\!\big(U_{ij}U_{jk}U_{ki}\big),\qquad
\tfrac{1}{2}\Tr\mathbf{H}(\partial\triangle)=\cos\!\left(F_\triangle/2\right) \label{eq:HolonomyTrace}\\[6pt]
