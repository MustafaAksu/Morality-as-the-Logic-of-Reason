...
% --- Encoding & fonts (safer PDF outputs) ---
...
% --- Figures (if you later add TikZ figures) ---
\usepackage{tikz}
...
% --- Metadata: DOI shown on title page ---
...
\DeclareMathOperator{\arccosop}{arccos}

% --- Title & Authors ---
\title{\papertitle}
\author{Mustafa Aksu\thanks{%
With contributions by Grok and ChatGPT (listed as \emph{contributors} in Zenodo metadata; sole human author of record).}}
\date{10 November 2025 \\[2pt]
...
% (same bibliography as your latest text)
\bibitem{Acebron2005}
Acebr\'{o}n, J. A., et al.,
...
% --- Optional: How to cite section for Zenodo landing page copy ---
\section*{How to cite}
Aksu, M. (\paperyear). \textit{\papertitle}. Zenodo. \href{https://doi.org/\paperdoi}{https://doi.org/\paperdoi}. \\
